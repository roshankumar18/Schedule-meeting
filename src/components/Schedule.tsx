  ...
  return (
    <div className="w-screen h-screen flex items-center justify-center">
      <form className="flex flex-col items-center" onSubmit={submitHandler}>
          ...
          return (
            <div className="flex gap-6 mb-2 " key={sch.day}>
              ...
              <label className="flex flex-col">
                Start Time :
                <select
                  className="border-[1px] p-1 mt-1 border-slate-400"
                  name="startTime"
        ...
        <button
          type="submit"
          className="bg-blue-400 p-2 mt-4  w-52 hover:bg-blue-600"
        >
          Save
        </button>
        {!!error && <div className="text-red-600 text-1xl">{error}</div>}
      </form>
    </div>
  );
};
